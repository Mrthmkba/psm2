...
import 'package:psm_coding_files/src/features/authentication/screens/login/login.dart'; // Import LoginScreen
            ...
            children: [
                ...
                children: [
                  SizedBox(
                    ...
                    child: ClipRRect(
                        ...
                        child: const Image(image: AssetImage("assets/logo/profile.png"),)),
                  ),
                  Positioned(
                    bottom: 0,
                    right: 0,
              ...
              ProfileMenuList(
                ...
                onPress: () {
                  ...
                  Get.offAll(() => const LoginScreen()); // Use Get.offAll to remove all routes
                },
              ),
            ],
          ),
